...
namespace IBM.Watson.DeveloperCloud.Services.SpeechToText.v1
{
    ...
    {
        // ShareVR
        List<string> ShareVRKeywords = new List<string> { "recording", "start", "stop" };
        ...
        private OnRecognize m_ListenCallback = null;
        // Callback is set by StartListening()
        private WSConnector m_ListenSocket = null;
        // WebSocket object used when StartListening() is invoked
        ...
        private int m_KeepAliveRoutine = 0;
        // ID of the keep alive co-routine
        private DateTime m_LastKeepAlive = DateTime.Now;
        private DateTime m_LastStartSent = DateTime.Now;
        private string m_RecognizeModel = "en-US_BroadbandModel";
        ...
        // If true, then we will try not to record silence.
        private float m_SilenceThreshold = 0.03f;
        // If the audio level is below this value, then it's considered silent.
        ...
        private void SendStart()
        {
            ...
            // ShareVR
            start["keywords"] = ShareVRKeywords.ToArray();
            start["keywords_threshold"] = 0.05f;
        ...
        private SpeechRecognitionEvent ParseRecognizeResponse( IDictionary resp )
        {
            ...
            try
            {
                ...
                foreach (var r in iresults)
                {
                    ...
                    // ShareVR - (Chen) added to parse keyword result
                    ...
                    foreach (string key in ShareVRKeywords)
                    {
