...
namespace IBM.Watson.DeveloperCloud.Utilities
{
	...
	public class Config
	{
		...
		{
			try {
				// ShareVR - (Chen) Modified to be able to run in Unity Editor mode
#if UNITY_EDITOR
				LoadConfig (System.IO.File.ReadAllText (Application.dataPath + "/ShareVR/Watson/" + Constants.Path.CONFIG_FILE));
#else
